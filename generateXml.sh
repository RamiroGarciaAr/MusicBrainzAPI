...
curl -o artist_info.xml "https://musicbrainz.org/ws/2/artist/$1?inc=works" 
echo "artist_info.xml generated."

curl -o recordings_info.xml "https://musicbrainz.org/ws/2/recording?query=arid:$1&limit=1000" 
